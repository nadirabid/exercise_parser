...
public struct EditableExerciseView: View {
    ...
    @ObservedObject var exerciseState: NewUserExerciseState
    ...
    init(
        exerciseState: NewUserExerciseState,
...
struct ExerciseEditorView_Previews: PreviewProvider {
    static var previews: some View {
        ScrollView {
            EditableExerciseView(exerciseState: NewUserExerciseState(input: "3x3 tricep curls"))
            EditableExerciseView(exerciseState: NewUserExerciseState(input: "3x3 tricep curls"))
            EditableExerciseView(exerciseState: NewUserExerciseState(input: "3x3 tricep curls"), resolveExercise: false)
            EditableExerciseView(exerciseState: NewUserExerciseState(input: "3x3 tricep curls"))
        }
