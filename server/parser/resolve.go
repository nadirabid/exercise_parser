...
func activityExpressions() []*expression {
	expressions := []*expression{
		newExpression(`^(?P<Reps>\d+|\d+\-\d+)\s*(?P<NotUnits>s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours|kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds|ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)?\s*(?:,+|-|\s)\s*(?P<Exercise>([a-zA-Z,\/\-\s]+?[a-zA-Z])$)`, nil, []string{"NotUnits"}),                                                                                                                // {Reps:Number}-{Reps:Number} (Delimiter) {Exercise:String}
		newExpression(`^(?P<Reps>\d+|\d+\-\d+)\s*(?P<NotUnits>s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours|kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds|ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)?\s*(?:reps)?\s*(?:,+|-|\s)\s*(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Weight>\d+)\s*(?P<WeightUnits>(kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds)$)`, nil, []string{"NotUnits"}), // {Reps:Number}-{Reps:Number} (Delimiter) {Exercise:String} (Delimiter) {Weight:Number}{WeightUnits}
		newExpression(`^(?P<Reps>\d+)\s*(?P<NotUnits>s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours|kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds|ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)?\s*(?:,+|-|\s)\s*(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Sets>\d+)\s*sets$`, nil, []string{"NotUnits"}),                                                                                      // {Reps:Number} (Delimiter) {Exercise:String} (Delimiter) {Sets:Number} sets
		...
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Reps>\d+)\s*(?:,+|-|\s)\s*(?P<Sets>\d+)\s*sets$`, nil, nil),                         // {Exercise:String} (Delimiter) {Reps:Number} (Delimiter) {Sets:Number} sets
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Calories>\d+)\s*(?:cals|calories)\s*(?:,+|-|\s)\s*(?P<Sets>\d+)\s*sets$`, nil, nil), // {Exercise:String} (Delimiter) {Calories:Number} cals (Delimiter) {Sets:Number} sets
		...
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Sets>\d+)\s*(?:sets|set)\s*(?P<Reps>\d+)\s*(?:reps|rep)\s*(?:,+|-|\s)\s*(?P<Weight>\d+)\s*(?P<WeightUnits>(kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds)$)`, nil, nil), // {Exercise:String} (Delimiter) {Sets:Number} sets {Reps:Number} reps (Delimiter) {Weight:Number}{WeightUnits}

		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Weight>\d+)\s*(?P<WeightUnits>kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds)$`, nil, nil),                                                                                                                                                                                                                              // {Exercise:String} (Delimiter) {Weight:Number}{WeightUnits}
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Weight>\d+)\s*(?P<WeightUnits>kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds)\s*(?:,+|-|\s)\s*(?P<Sets>\d+)\s*(?:sets)\s*(?P<Reps>\d+)\s*(?:reps)$`, nil, nil),                                                                                                                                                          // {Exercise:String} (Delimiter) {Weight:Number}{WeightUnits} (Delimiter) {Sets:Number} sets {Reps:Number} reps
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Weight>\d+)\s*(?P<WeightUnits>kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds)\s*(dumbbell|dumbbells|barbel|barbells)?\s*(?P<Reps>\d+)\s*(:?reps)?$`, nil, nil),                                                                                                                                                          // {Exercise:String} (Delimiter) {Weight:Number}{WeightUnits} {Reps:Number} reps?
		...
		newExpression(`^(?P<Time>\d+|\d+\-\d+)\s*(?P<TimeUnits>s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours)\s*(?:,+|-|\s)\s*(?:of)?\s*(?P<Exercise>([a-zA-Z,\/\-\s]+?[a-zA-Z]))\s*(?:,+|-|\s)\s*(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)$`, nil, nil), // {Time}{TimeUnits} {Exercise:String} {Distance}{DistanceUnits}
		...
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>(ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)$)`, map[string][]string{"Exercise": {"for"}}, nil), // {Exercise:String} (Delimiter) {Distance:Float}{DistanceUnits} :TODO - delimiter test
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s+(?:for)\s+(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>(ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)$)`, nil, nil),                                          // {Exercise:String} for {Distance:Float}{DistanceUnits}

		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Time>\d+)\s*(?P<TimeUnits>s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours)\s*(?:,+|-|\s)\s*(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>(ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)$)`, map[string][]string{"Exercise": {"for"}}, nil), // {Exercise:String} (Delimiter) {Time:Number}{TimeUnits} (Delimiter) {Distance}{DistanceUnits}
		...
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)\s*(?:,+|-|\s)\s*(?:in)?\s*(?P<Time>\d+)\s*(?P<TimeUnits>(s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours)$)`, nil, nil), // {Exercise:String} (Delimiter) {Distance:Float}{DistanceUnits} (Delimiter) in? {Time:Number}{TimeUnits} :TODO - add delimiter ttest

		newExpression(`^(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)\s*(?:,+|-|\s)\s*(?:in)\s*(?P<Time>\d{1,2}\:\d{2})\s*(?:,+|-|\s)\s*(?P<Exercise>([a-zA-Z,\/\-\s]+?[a-zA-Z])$)`, nil, nil),                                                                    // {Distance:Float}{DistanceUnits} (Delimiter) in {Time:mm:ss} (Delimiter) {Exercise:String}
		...
		newExpression(`^(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)\s*(?:,+|-|\s)\s*(?P<Exercise>([a-zA-Z,\/\-\s]+?[a-zA-Z]))\s*(?:,+|-|\s)\s*(?:in)?\s*(?P<Time>\d+)\s*(?P<TimeUnits>s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours)$`, nil, nil),       // {Distance:Float}{DistanceUnits} (Delmiter) {Exercise:String} (Delimiter) in {Time}{TimeUnits}
		newExpression(`^(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)\s*(?:,+|-|\s)\s*(?:of)?\s*(?P<Exercise>([a-zA-Z,\/\-\s]+?[a-zA-Z])$)`, nil, nil),                                                                                                            // {Distance:Float}{DistanceUnits} (Delimiter) of? {Exercise:String} :TODO - delimiter test
		newExpression(`^(?P<Distance>([0-9]*[.])?[0-9]+)\s*(?P<DistanceUnits>ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)\s*(?:,+|-|\s)\s*(?:of)?\s*(?P<Exercise>([a-zA-Z,\/\-\s]+?[a-zA-Z]))\s*(?:in)\s*(?P<Time>\d{1,2}\:\d{2})\s*(?P<TimeUnits>s|sec|secs|seconds|min|mins|minutes|hr|hrs|hour|hours)$`, nil, nil), // {Distance:Float}{DistanceUnits} (Delimiter) of? {Exercise:String} in? {Time:mm:ss}{TimeUnits}
		newExpression(`^(?P<Distance>[0-9]*[.][0-9]+)\s*(?P<NotDistanceUnits>ft|foot|feet|mi|mils|mile|miles|m|meter|meters|kilometer|kilometers|km|k)?\s*(?:of)?\s*(?P<Exercise>([a-zA-Z,\/\-\s]+?[a-zA-Z])$)`, nil, []string{"NotDistanceUnits"}),                                                                                                // {Distance:Float} of? {Exercise:String} :TODO - delimiter test
	}
