...
func activityExpressions() []*expression {
	expressions := []*expression{
		...
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Sets>\d+)\s*(?:sets)\s*(?:,+|-|\s)\s*(?P<Weight>\d+)\s*(?P<WeightUnits>(kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds)$)`, nil, nil),                            // {Exercise:String} (Delimiter) {Sets:Number} sets (Delimiter) {Weight:Number}{WeightUnits}
		newExpression(`^(?P<Exercise>[a-zA-Z,\/\-\s]+?[a-zA-Z])\s*(?:,+|-|\s)\s*(?P<Sets>\d+)\s*(?:sets)\s*(?P<Reps>\d+)\s*(?:reps)\s*(?:,+|-|\s)\s*(?P<Weight>\d+)\s*(?P<WeightUnits>(kg|kilos|kilogram|kilograms|lb|lbs|pound|pounds)$)`, nil, nil), // {Exercise:String} (Delimiter) {Sets:Number} sets {Reps:Number} reps (Delimiter) {Weight:Number}{WeightUnits}
